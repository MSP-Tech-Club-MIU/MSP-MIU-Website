...
const SEO = ({
  ...
  return (
    <Helmet>
      ...
      <link rel="icon" type="image/png" sizes="32x32" href="https://msp-miu.tech/assets/msp-logo-favicon.png" />
      <link rel="apple-touch-icon" sizes="180x180" href="https://msp-miu.tech/assets/msp-logo-favicon.png" />
