 ...
 */
const SEO = ({
  title = 'MSP Tech Club - MIU | Microsoft Student Partners',
  ...
  image = 'https://msp-miu.tech/src/assets/Images/msp-logo.png',
  url = 'https://msp-miu.tech',
  type = 'website',
  structuredData = null,
  noindex = false
}) => {
  const fullTitle = title.includes('MSP') ? title : `${title} | MSP Tech Club - MIU`;
